...
},settings:{title:"Stillingar"},forms:{phoneInvalid:"Sláðu inn amk {length} tölur"},privacyNotice:{title:"Vinnsla persónulegra gagna"}}),Locale.inherit("is","en"),Locale.define("it","app",{messages:{agentjoin:"{name} si è unito alla chat",agentleave:"{name} ha lasciato la chat",transfer:"La chat è stata trasferita a {name}",rating:"La chat è stata valutata"},dialogClose:{title:"Vorresti terminare la chat?",yes:"Sì",no:"No",send:"Sì e inviami la chat all'email"},dialogSend:{title:"Invia la chat all'email",email:"Email",yes:"Invia",no:"Cancella"},dialogRating:{title:"Come valuteresti questa chat?",cancel:"Non voglio valutare la chat",submit:"Invia",commentTitle:"Il tuo commento"},online:{title:"Supporto",infoTitle:"Live chat",infoDesc:"Chiedici qualsiasi cosa",maximize:"Massimizza",minimize:"Minimizza",hideTitle:"Nascondi chat",closeTitle:"Chiudi chat",settingsTitle:"Impostazioni",disableSounds:"Disattiva i suoni",enableSounds:"Attiva i suoni",visitor:"Io",send:"Invia",textareaPlaceholder:"Scrivi qua e premi Invio per inviare",
typingMsg:"{name} sta scrivendo...",transcriptSendingTitle:"Inviando l'email...",transcriptSendedTitle:"L'email è stata inviata correttamente",rate:"Valuta l'agente"},login:{title:"Accesso chat",messageLabel:"La tua domanda",submit:"Inizia chat"},offline:{title:"Inviaci un messaggio",notice:"Non siamo disponibili in questo momento, ma puoi lasciarci un messaggio. Ti risponderemo il prima possibile.",hideTitle:"Nascondi chat",name:"Nome",email:"Email",message:"Il tuo messaggio",submit:"Invia messaggio",messageRequiredAlert:"Non hai inserito un messaggio",emailRequiredAlert:"Non hai inserito un indirizzo email",emailInvalidAlert:"Indirizzo email non valido",sendInfo:"Inviando l'email...",successTitle:"Grazie per il tuo messaggio",successDesc:"Il tuo messaggio è stato inviato correttamente. Ti contatteremo presto.",failureTitle:"C'è stato un errore durante l'invio",failureDesc:"Il tuo messaggio non è stato inviato",number:"Numero di telefono"},widget:{online:"Online",away:"Fuori",offline:"Offline"
},banner:{bubble:{text:"Siamo pronti per ricevere le tue domande"},arrow:{title:"Qualche domanda?",desc:"Siamo pronti a rispondere"}},button:{title:"Chat"},settings:{title:"Impostazioni"},forms:{phoneInvalid:"Inserisci almeno {length} numeri"},privacyNotice:{title:"Trattamento dei dati personali",text:"I dati personali sono elaborati da Smartsupp.com, s.r.o., P. IVA CZ03668681 (successivamente \"Smartsupp\") inteso come un processore di dati che opera a nome del proprietario del sito web, che è colui che gestisce i dati.\nSmartsupp è conforme alle norme GDPR. Puoi trovare maggiori informazioni riguardo la protezione dei dati personali su www.smartsupp.com/privacy. L'elaborazione dei dati personali è necessaria per garantire il servizio clienti. Contatta gentilmente il proprietario del sito web per qualsiasi domanda riguardo l'elaborazione dei dati personali o se desideri cancellare i tuoi dati personali."}}),Locale.inherit("it","en"),Locale.define("ja","app",{messages:{agentjoin:"{name} チャットに参加しました",
agentleave:"チャットを退出しました",transfer:"チャットは{name}に転送されました",rating:"チャットが評価されました"},dialogClose:{title:"チャットを終了しますか？",yes:"はい",no:"いいえ",send:"はい。チャットの内容をメールで送る"},dialogSend:{title:"チャットの内容をメールで送る",email:"メール",yes:"送信",no:"キャンセル"},dialogRating:{title:"このチャットを評価して頂けますか？",cancel:"評価したくありません",submit:"送信",commentTitle:"コメント"},online:{title:"サポート",infoTitle:"ライブチャット",infoDesc:"何でもご質問下さい",maximize:"最大化",minimize:"最小化",hideTitle:"チャットを隠す",closeTitle:"チャットを閉じる",settingsTitle:"セッティング",disableSounds:"無効な音",enableSounds:"有効な音",visitor:"私",send:"送信",textareaPlaceholder:"ここに文章を書き、<enter>を押してメッセージ送信して下さい",typingMsg:"{name}はタイプ中",transcriptSendingTitle:"メールを送信中",transcriptSendedTitle:"メールが送信されました",rate:"評価の高い担当者"},login:{title:"チャットにログイン",messageLabel:"あなたの質問",submit:"チャットを始める"},offline:{title:"メッセージをお送り下さい",notice:"只今担当が席を外しております。メッセージを残して頂ければ出来る限り早くご返信させて頂きます。",hideTitle:"チャットを隠す",name:"名前",email:"メール",message:"あなたのメッセージ",submit:"メッセージ送信",messageRequiredAlert:"メッセージが入力されていません",emailRequiredAlert:"メールアドレスが入力されていません",
emailInvalidAlert:"無効なメールアドレス",sendInfo:"メールを送信中",successTitle:"お問い合わせ誠に有り難うございます",successDesc:"メッセージ送信完了。すぐにご返信させて頂きます。",failureTitle:"エラー",failureDesc:"メッセージは送信されませんでした",number:"電話番号"},widget:{online:"オンライン",away:"席を外しています",offline:"オフライン"},banner:{bubble:{text:"ご質問をどうぞ"},arrow:{title:"ご質問はございますか？",desc:"回答致します"}},button:{title:"チャット"},settings:{title:"セッティング"},forms:{phoneInvalid:"少なくとも{length}つの数字を入力してください"},privacyNotice:{title:"個人データ処理"}}),Locale.inherit("ja","en"),Locale.define("ka","app",{messages:{agentjoin:"{name} შემოუერთდა ჩეთს",agentleave:"{name} დატოვა ჩეთი",transfer:"ჩეთი გადაირთო ოპერატორთან  {name}",rating:"ჩატი შეაფასა"},dialogClose:{title:"გნებავთ ჩეთის დასრულება?",yes:"დიახ",no:"არა",send:"დიახ, და გამომიგზავნეთ ჩეთი ელ-ფოსტაზე"},dialogSend:{title:"გამომიგზავნეთ ჩეთი ელ-ფოსტაზე",email:"ელ-ფოსტა",yes:"გაგზავნა",no:"გაუქმება"},dialogRating:{title:"როგორ შეაფასებთ საუბარს?",cancel:"არ მსურს შეფასება",submit:"გაგზავნა",commentTitle:"თქვენი კომენტარი"},online:{title:"დახმარება",
infoTitle:"ონლაინშია",infoDesc:"გვკითხეთ",maximize:"გადიდება",minimize:"დაპატარავება",hideTitle:"ჩახურვა",closeTitle:"დახურვა",settingsTitle:"პარამეტრები",disableSounds:"ხმის გათიშვა",enableSounds:"ხმის ჩართვა",visitor:"მე",send:"გაგზავნა",textareaPlaceholder:"დაწერეთ აქ, დააჭირეთ <Enter>-ს გასაგზავნად",typingMsg:"{name} წერს",transcriptSendingTitle:"ვაგზავნით ელ-ფოსტაზე",transcriptSendedTitle:"მესიჯი წარმატებით გაიგზავნა",rate:"შეფასება აგენტი"},login:{title:"ჩეთში შესვლა",messageLabel:"თქვენი შეკითხვა",submit:"ჩეთის დაწყება"},offline:{title:"მოგვწერეთ",notice:"ამ მომენტში ხაზზე არ ვართ, მაგრამ თქვენ შეგიძლიათ დაგვიტოვოთ შეტყობინება და ჩვენ მალე გიპასუხებთ.",hideTitle:"ჩეთის დამალვა",name:"სახელი",email:"ელ-ფოსტა",message:"თქვენი მესიჯი",submit:"მესიჯის გაგზავნა",messageRequiredAlert:"თქვენ არ შეგიყვანიათ მესიჯი",emailRequiredAlert:"თქვენ  არ შეგიყვანიათ ელ-ფოსტა",emailInvalidAlert:"არასწწორი ელ-ფოსტა",sendInfo:"ვაგზავნით მესიჯს",successTitle:"მადლობა თქვენი მესიჯისთვის",successDesc:"თქვენი მესიჯი წარმატებით გაიგზავნა. ჩვენ მალე დაგიკავშირდებით.",
failureTitle:"შეცდომა",failureDesc:"თქვენი მეიჯი ვერ გაიგზავნა",number:"ტელეფონის ნომერი"},widget:{online:"ხაზზეა",away:"დაკავებულია",offline:"გასულია"},banner:{bubble:{text:"მზად ვართ თქვენი კითხვის მისაღებად"},arrow:{title:"კითხვა გაქვთ?",desc:"მზად ვართ გიპასუხოთ"}},button:{title:"ონლაინ ჩეთი"},settings:{title:"პარამეტრები"},forms:{phoneInvalid:"შეიყვანეთ მინიმუმ {length} ნომერი"},privacyNotice:{title:"პერსონალური მონაცემების დამუშავება"}}),Locale.inherit("ka","en"),Locale.define("lt","app",{messages:{agentjoin:"{name} prisijungė prie pokalbio",agentleave:"{name} atsijungė nuo pokalbio",transfer:"Pokalbis perduotas {name}",rating:"Pokalbis buvo įvertintas"},dialogClose:{title:"Ar norite baigti pokalbį?",yes:"Taip",no:"Ne",send:"Taip, ir tęskite pokalbį el. paštu"},dialogSend:{title:"Išsiųsti pokalbį į el. paštą",email:"El. paštas",yes:"Siųsti",no:"Baigti"},dialogRating:{title:"Kaip įvertintumėte pokalbį?",cancel:"Nenoriu vertinti",submit:"Siųsti",commentTitle:"Jūsų komentaras"},online:{
title:"Pagalba",infoTitle:"Pokalbis internetu",infoDesc:"Klauskite mūsų",maximize:"Išskleisti",minimize:"Suskleisti",hideTitle:"Paslėpti pokalbį",closeTitle:"Baigti pokalbį",settingsTitle:"Nustatymai",disableSounds:"Išjungti garsą",enableSounds:"Įjungti garsą",visitor:"Aš",send:"Siųsti",textareaPlaceholder:"Rašykite čia, spauskite <enter> išsiųsti",typingMsg:"{name} rašo ...",transcriptSendingTitle:"Siunčiamas el. laiškas",transcriptSendedTitle:"E. laiškas išsiųstas",rate:"Įvertinti agentą"},login:{title:"Prisijungti prie pokalbio",messageLabel:"Klauskite",submit:"Pradėti pokalbį"},offline:{title:"Atsiųskite mums žinutę",notice:"Šiuo metu negalime atsakyti, palikite mums žinutę, atsakysime kaip galima greičiau.",hideTitle:"Paslėpti pokalbį",name:"Vardas",email:"El. paštas",message:"Jūsų žinutė",submit:"Siųsti",messageRequiredAlert:"Neįrašėte žinutės",emailRequiredAlert:"Neįrašėte el. pašto adreso",emailInvalidAlert:"Neteisingas el. pašto adresas",sendInfo:"Siunčiamas el. laiškas",successTitle:"Ačiū už Jūsų žinutę",
successDesc:"Jūsų žinutė sėkmingai išsiųsta. Susisieksime su Jumis artimiausiu metu.",failureTitle:"Klaida",failureDesc:"Jūsų žinutė neišsiųsta",number:"Telefono numeris"},widget:{online:"Prisijungęs\n",away:"Atsitraukęs",offline:"Neprisijungęs"},banner:{bubble:{text:"Laukiame Jūsų klausimų"},arrow:{title:"Ar turite klausimų?",desc:"Gal galime padėti"}},button:{title:"Pokalbis"},settings:{title:"Nustatymai"},forms:{phoneInvalid:"Įveskite bent {length} numerius"},privacyNotice:{title:"Asmens duomenų tvarkymas"}}),Locale.inherit("lt","en"),Locale.define("lv","app",{messages:{agentjoin:"{name} pievienojās čatam",agentleave:"{name} pameta čatu",transfer:"Čats pārsūtīts {name}",rating:"Čats tika novērtēts"},dialogClose:{title:"Vai vēlaties beigt čatu?",yes:"Jā",no:"Nē",send:"Jā, nosūtīt kopiju epastā"},dialogSend:{title:"Sūtīt čatu uz epastu",email:"E-pasts",yes:"Sūtīt",no:"Atcelt"},dialogRating:{title:"Kā tu novērtētu čatu?",cancel:"Nevēlos vērtēt",submit:"Sūtīt",commentTitle:"Tavs komentārs"
},online:{title:"Atbalsts",infoTitle:"Online čats",infoDesc:"Jautā mums",maximize:"Palielināt",minimize:"Samazināt",hideTitle:"Paslēpt čatu",closeTitle:"Aizvērt čatu",settingsTitle:"Iestatījumi",disableSounds:"Izslēgt skaņu",enableSounds:"Ieslēgt skaņu",visitor:"Es",send:"Sūtīt",textareaPlaceholder:"Raksti šeit, spied <enter> lai nosūtītu",typingMsg:"{name} raksta ...",transcriptSendingTitle:"Sūta e-pastu",transcriptSendedTitle:"E-pasts nosūtīts",rate:"Novērtēt aģentu"},login:{title:"Chat login",messageLabel:"Tavs jautājums",submit:"Sākt čatu"},offline:{title:"Nosūtīt mums ziņu",notice:"Lūdzu atstājiet ziņu, mēs atbildēsim tiklīdz tas būs iespējams.",hideTitle:"Paslēpt čatu",name:"Vārds",email:"E-pasts",message:"Tava ziņa",submit:"Sūtīt ziņu",messageRequiredAlert:"Ziņojuma teksts nav ievadīts",emailRequiredAlert:"Lūdzu norādiet savu e-pastu",emailInvalidAlert:"Nepareizs e-pasts",sendInfo:"Sūta e-pastu...",successTitle:"Paldies par ziņu",successDesc:"Ziņa nosūtīta veiksmīgi. Sazināsimies tuvākajā laikā.",
failureTitle:"Kļūda",failureDesc:"Ziņojums nosūtīts",number:"Tālruņa numurs"},widget:{online:"Online",away:"Away",offline:"Offline"},banner:{bubble:{text:"Esam gatavi atbildēt"},arrow:{title:"Jautājumi?",desc:"Esam gatavi atbildēt"}},button:{title:"Čats"},settings:{title:"Iestatījumi"},forms:{phoneInvalid:"Levadiet vismaz {length} numurus"},privacyNotice:{title:"Personas datu apstrāde"}}),Locale.inherit("lv","en"),Locale.define("mk","app",{messages:{agentjoin:"{name} се приклучи на chat-от",agentleave:"{name} го напушти chat- от",transfer:"Chat-от е пренасочен кон {name}",rating:"Chat-от беше оценет"},dialogClose:{title:"Дали сакате да го завршите овој разговор?",yes:"Да",no:"Не",send:"Да, и испратете ми транскрипт од кумникацијата на е-маил"},dialogSend:{title:"Испрати ја комуникацијата на е-маил",email:"Е-маил",yes:"Испрати",no:"Откажи"},dialogRating:{title:"Како би ја оцениле помошта на chat-от?",cancel:"Не сакам да дадам оценка",submit:"Испрати",commentTitle:"Ваш коментар"},online:{
title:"Корисничка поддршка",infoTitle:"Chat во живо",infoDesc:"Прашајте се што сакате",maximize:"Зголеми",minimize:"Намали",hideTitle:"Сокриј го chat-от",closeTitle:"Затвори го chat-от",settingsTitle:"Подесувања",disableSounds:"Исклучи звук",enableSounds:"Вклучи звук",visitor:"Јас",send:"Испрати",textareaPlaceholder:"Напишете овде, кликнете <ENTER> за да испратите",typingMsg:"{name} ти пишува...",transcriptSendingTitle:"Е-маилот се испраќа...",transcriptSendedTitle:"E-маилот е успешно пратен",rate:"Оценете го агентот"},login:{title:"Пријава за Chat",messageLabel:"Вашето прашање",submit:"Започнете разговор"},offline:{title:"Напишете ни порака",notice:"Во моментот не сме online, но можете да ни оставите порака па ќе ви се јавиме",hideTitle:"Сокриј го chat-oт",name:"Име",email:"Е-маил",message:"Порака",submit:"Испрати порака",messageRequiredAlert:"Немате ништо напишано во пораката",emailRequiredAlert:"Не го напишавте вашиот е-маил",emailInvalidAlert:"Непостоечка е-маил адреса",sendInfo:"Е-маилот се испраќа...",
successTitle:"Ви благодариме на пораката",successDesc:"Пораката е успешно испратена. Набрзо ќе ве контактираме.",failureTitle:"Грешка",failureDesc:"Извинете, но пораката не е испратена",number:"Телефон"},widget:{online:"Имате ли некое прашање за нас?",away:"Имате ли некое прашање за нас?",offline:"Оставете ни порака"},banner:{bubble:{text:"Подготвени сме за вашите прашања!"},arrow:{title:"Имате ли некое прашање?",desc:"Со задоволтво ќе ви одговориме"}},button:{title:"Chat во живо"},settings:{title:"Подесувања"},forms:{phoneInvalid:"Внесете најмалку {length} броеви"},privacyNotice:{title:"Обработка на лични податоци"}}),Locale.inherit("mk","en"),Locale.define("nl","app",{messages:{agentjoin:"{name} heeft deelgenomen aan de chat",agentleave:"{name} heeft chat verlaten",transfer:"Chat overgedragen naar {name}",rating:"De chat werd beoordeeld"},dialogClose:{title:"Wilt u de chat graag beëindigen?",yes:"Ja",no:"Nee",send:"Ja, stuur de chat naar mijn e-mail"},dialogSend:{title:"Stuur de chat naar mijn e-mail",
email:"E-mail",yes:"Verzenden",no:"Annuleren"},dialogRating:{title:"Hoe zou u deze chat beoordelen?",submit:"Verzenden",commentTitle:"Uw opmerking",cancel:"Ik wil de chat niet beoordelen"},online:{title:"Hulp",infoTitle:"Live chat",infoDesc:"Vraag ons alles",maximize:"Maximaliseer",minimize:"Minimaliseer",hideTitle:"Verberg de chat",closeTitle:"Sluit de chat",settingsTitle:"Instellingen",disableSounds:"Zet het geluid uit",enableSounds:"Zet het geluid aan",visitor:"Ik",send:"Verzenden",textareaPlaceholder:"Schrijf hier en druk op Enter om te verzenden",typingMsg:"{name} is aan het typen...",transcriptSendingTitle:"E-mail aan het verzenden...",transcriptSendedTitle:"E-mail is verzonden",rate:"Beoordeel uw agent"},login:{title:"Chat login",messageLabel:"Uw vraag",submit:"Begin de chat"},offline:{title:"Stuur ons een bericht",notice:"We zijn momenteel niet beschikbaar, maar u kunt ons een bericht achterlaten. Wij zullen zo spoedig mogelijk reageren.",hideTitle:"Verberg de chat",name:"Naam",
email:"E-mail",message:"Uw bericht",submit:"Bericht verzenden",messageRequiredAlert:"U heeft geen bericht geschreven",emailRequiredAlert:"U heeft geen e-mail adres ingegeven",emailInvalidAlert:"Onjuist e-mail adres",sendInfo:"E-mail is aan het verzenden...",successTitle:"Bedankt voor uw bericht",successDesc:"Uw bericht is succesvol verzonden. We zullen spoedig contact met u opnemen.",failureTitle:"Er was een fout bij het verzenden",failureDesc:"Uw bericht werd niet verzonden",number:"Telefoonnummer"},widget:{online:"Online",away:"Afwezig",offline:"Offline"},banner:{bubble:{text:"We zijn klaar voor uw vragen"},arrow:{title:"Heeft u vragen?",desc:"We zijn klaar om te antwoorden"}},button:{title:"Chat"},settings:{title:"Instellingen"},forms:{phoneInvalid:"Geef ten minste {length} nummers in"},privacyNotice:{title:"Verwerking van persoonsgegevens",text:'Persoonsgegevens worden verwerkt door Smartsupp.com, s.r.o., BTW-nummer CZ03668681 (verder als "Smartsupp") die als een gegevensverwerker optreedt namens de eigenaar van de website die de gegevenscontrolleur is. Smartsupp voldoet aan de AVG. U kan meer informatie over de verwerking van privacy- en persoonsgegevens van Smartsupp vinden op www.smartsupp.com/privacy. De verwerking van persoonsgegevens is noodzakelijk om u klantenservice te kunnen leveren. Neem contact op met de eigenaar van de website al u vragen hebt over de verwerking van persoonsgegevens, of als u deze wilt opvragen of verwijderen.'
